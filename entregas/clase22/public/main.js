...
chatForm.addEventListener("submit", (e) => {
    ...
    return fetch(`http://localhost:8080/api/mensajes/`, {
        ...
        body: JSON.stringify({
            "author": {
                "email": e.target.email.value, "nombre": e.target.nombre.value, "apellido": e.target.apellido.value, "edad": e.target.edad.value,
                "alias": e.target.alias.value, "avatar": e.target.avatar.value
